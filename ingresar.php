<?php require_once('Connections/conexiontrabajo.php'); ?>
<?php
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  ...
  mysql_select_db($database_conexiontrabajo, $conexiontrabajo);
  $Result1 = mysql_query($insertSQL, $conexiontrabajo) or die(mysql_error());
...
mysql_select_db($database_conexiontrabajo, $conexiontrabajo);
$query_ingresar = "SELECT * FROM persona";
$ingresar = mysql_query($query_ingresar, $conexiontrabajo) or die(mysql_error());
