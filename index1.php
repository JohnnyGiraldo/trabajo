...
mysql_select_db($database_Johnny, $Johnny);
$query_Recordset1 = sprintf("SELECT * FROM persona WHERE cedula = %s", GetSQLValueString($colname_Recordset1, "int"));
$Recordset1 = mysql_query($query_Recordset1, $Johnny) or die(mysql_error());
...
if (isset($_POST['usuario'])) {
  ...
  $LoginRS = mysql_query($LoginRS__query, $conexiontrabajo) or die(mysql_error());
